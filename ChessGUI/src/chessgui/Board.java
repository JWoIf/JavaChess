...
public class Board extends JComponent {
    ...
    public void initGrid()
    {
        ...
        White_Pieces.add(new Queen(5,0,true,"Queen.png",this, false));
        White_Pieces.add(new Bishop(3,0,true,"Bishop.png",this, false));
        White_Pieces.add(new Bishop(6,0,true,"Bishop.png",this, false));
        White_Pieces.add(new Knight(2,0,true,"Knight.png",this, false));
        White_Pieces.add(new Knight(7,0,true,"Knight.png",this, false));
        White_Pieces.add(new Jester(1,0, true, "Jester.png", this, true));
        White_Pieces.add(new Jester(8,0, true, "Jester.png", this, true));
        White_Pieces.add(new Rook(0,0,true,"Rook.png",this, false));
        White_Pieces.add(new Rook(9,0,true,"Rook.png",this, false));
        White_Pieces.add(new Pawn(0,1,true,"Pawn.png",this, false));
        White_Pieces.add(new Pawn(1,1,true,"Pawn.png",this, false));
        White_Pieces.add(new Pawn(2,1,true,"Pawn.png",this, false));
        White_Pieces.add(new Pawn(3,1,true,"Pawn.png",this, false));
        White_Pieces.add(new Pawn(4,1,true,"Pawn.png",this, false));
        White_Pieces.add(new Pawn(5,1,true,"Pawn.png",this, false));
        White_Pieces.add(new Pawn(6,1,true,"Pawn.png",this, false));
        White_Pieces.add(new Pawn(7,1,true,"Pawn.png",this, false));
        White_Pieces.add(new Pawn(8,1,true,"Pawn.png",this, false));
        White_Pieces.add(new Pawn(9,1,true,"Pawn.png",this, false));

        Black_Pieces.add(new King(4,7,false,"King.png",this, false));
        Black_Pieces.add(new Queen(5,7,false,"Queen.png",this, false));
        Black_Pieces.add(new Bishop(3,7,false,"Bishop.png",this, false));
        Black_Pieces.add(new Bishop(6,7,false,"Bishop.png",this, false));
        Black_Pieces.add(new Knight(2,7,false,"Knight.png",this, false));
        Black_Pieces.add(new Knight(7,7,false,"Knight.png",this, false));
        Black_Pieces.add(new Jester(1,7, false, "Jester.png", this, true));
        Black_Pieces.add(new Jester(8,7, false, "Jester.png", this, true));
        Black_Pieces.add(new Rook(0,7,false,"Rook.png",this, false));
        Black_Pieces.add(new Rook(9,7,false,"Rook.png",this, false));
        ...
        Black_Pieces.add(new Pawn(9,6,false,"Pawn.png",this, false));
    ...
    public Board() {
        ...
        this.setMinimumSize(new Dimension(125, 100));
        this.setMaximumSize(new Dimension(1250, 1000));
    ...
    private MouseAdapter mouseAdapter = new MouseAdapter() {
        ...
        public void mousePressed(MouseEvent e) {
                    ...
                    && ((is_whites_turn && Active_Piece.isWhite()) || (!is_whites_turn && Active_Piece.isBlack())))
            {
                ...
                {
                	if (Active_Piece.isJester()) {
                		clicked_piece.setX(Active_Piece.getX());
                		clicked_piece.setY(Active_Piece.getY());
                	}
                	else if (clicked_piece.isWhite())
                    {
